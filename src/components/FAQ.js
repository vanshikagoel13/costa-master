	...
	return (
		<>
            ...
            <div className="heading" style={{marginTop:'40px'}}>
              <h1 className="main-heading head-faq PoppBold">FAQ</h1>
						...
						<div className="scroll-container">
							<div className="container container-faq">
								...
								<TextBox
									...
									answer="There are normally four types of cabins on board ships:
      Inside cabins that are comfortable with no view.
      
      Outside cabins are cabins that have fixed windows that cannot be opened, but provide you with a sea view.
      
      Balcony cabins are cabins that have a balcony attached to the cabin.
      
      Suites cabins are little larger areas with bedroom, sitting space with panorama windows or balcony attached.
      
      All the cabins are very comfortable and well furnished, equipped with television, private bath and shower and hair dryer.
      "
								/>
								<TextBox
