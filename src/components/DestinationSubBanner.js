...
import "../styles/DestinationSubBanner.css";
...
function DestinationSubBanner({ details }) {

	return (

		<div className="allin-des">
			<div class="detail-container-des d-flex">
				<div class="row g-0 align-hori-des flex" style= {{ width: '100%'}}>
					...
					<div class="col-sm-7 main-column-2-des flex-column">
						...
						<div class="row h-80 row-2 justify-content-center">
							<div class="col-sm-4 space-des">
								<img src={process.env.PUBLIC_URL+details.i1} alt="Error" className="Icon-Img-des"></img>
								{/* <p className="item-count">505</p> */}
								<p className="item-detail-des PoppReg">{details.text1}</p>
							</div>
							<div class="col-sm-4 space-des">
								<img src={process.env.PUBLIC_URL+details.i2} alt="Error" className="Icon-Img-des"></img>
								{/* <p className="item-count">4</p> */}
								<p className="item-detail-des PoppReg">{details.text2}</p>
							</div>
							<div class="col-sm-4 space-des">
								<img src={process.env.PUBLIC_URL+details.i3} alt="Error" className="Icon-Img-des"></img>
...
export default DestinationSubBanner;
