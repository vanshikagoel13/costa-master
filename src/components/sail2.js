...
function Sail2() {
  return (
    <section id="Sail" style={{marginTop:"70px"}}>
      ...
      {/* <div className="sail">
				{/* <div className="row justify-content-center sail-content"  style={{backgroundColor: "purple"}}>
					<div className="col-lg-9 info-box" style={{ width: '82%', height: '800px' }}>
						<div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4" style={{ height: '45%' }}>
							<div className="col">
								<Card />
							</div>
							<div className="col">
