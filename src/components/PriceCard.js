	...
	return (
		...
		<div className="card mx-2">
			...
			<div className="card-body">
				...
				<h6 className="card-title card-subtitle AltReg">{imagecom.loc}</h6>
				<p className="card-text departure AltReg"><small className="text-muted">Departure Date</small></p>
				<p className="card-text departure-date PoppReg"><small className="text-muted">{imagecom.date}</small></p>
				<p className="card-text price-per-person AltReg"><small className="text-muted">Price per person</small></p>
